...
<body>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
            <?php $query = "SELECT * FROM up_files where exp < now() + interval 30 day and exp NOT IN ('0000-00-00')"; 

            $result = mysql_query($query);
            $row = mysql_num_rows($result);                        
                        echo "<div class='huge'>".$row."</div>";            
                    ?>                
                                    <div>Certificate Expiracy</div>
                                </div>
                            </div>
                        </div>
                        <a href="exp.php">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-info fa-fw"></i> Vessel Locations
  ...
  var show_track=true;
  var fleet="e70a81e816a655e4282e6215cea6039f";
