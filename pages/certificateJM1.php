...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">JM Sutera 1 Records</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <th width="90px"><strong>Issued Date</strong></th>
                    <th width="90px"><strong>Expired Date </strong></th>
...
<!--where vessel='JM Sutera 1'-->
 <?php $query = "SELECT * FROM up_files where title='CUSTOMS AND QUARANTINE (ONBOARD ONLY)' and vessel='JM Sutera 1'"; 
...
<!--where vessel='JM Sutera 1'-->
 ...
 <?php $query = "SELECT * FROM up_files where title='OWNERSHIP, ISM, ISPS, ISO, SAFE MANNING, ITF, P&I' and vessel='JM Sutera 1'"; 
        ...
        // replace the A href link with 
                ...
                <div class="col-lg-12">
                    ...
                    <th><strong>Edit</strong></th>
                        ...
                        <tbody>
<!--where vessel='JM Sutera 1'-->
 <?php $query = "SELECT * FROM up_files where title='TONNAGE, LOADLINE, SOLAS' and vessel='JM Sutera 1'"; 
        ...
        // replace the A href link with 
                ...
                <div class="col-lg-12">
                    ...
                    <th><strong>Edit</strong></th>
                        ...
                        <tbody>
<!--where vessel='JM Sutera 1'-->
 <?php $query = "SELECT * FROM up_files where title='MARPOL' and vessel='JM Sutera 1'"; 
        ...
        // replace the A href link with 
                ...
                <div class="col-lg-12">
                    ...
                    <th><strong>Edit</strong></th>
                        ...
                        <tbody>
<!--where vessel='JM Sutera 1'-->
 <?php $query = "SELECT * FROM up_files where title='Class' and vessel='JM Sutera 1'"; 
        ...
        // replace the A href link with 
                ...
                <div class="col-lg-12">
                    ...
                    <th><strong>Edit</strong></th>
                        ...
                        <tbody>
<!--where vessel='JM Sutera 1'-->
 <?php $query = "SELECT * FROM up_files where title='Miscellaneous' and vessel='JM Sutera 1'"; 
