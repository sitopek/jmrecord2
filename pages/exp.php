...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Expired Notification</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <th width="90px" bgcolor="red"><strong>Expired Date </strong></th>
...
<?php $query = "SELECT * FROM up_files where exp < now() + interval 30 day and exp NOT IN ('0000-00-00') and vessel='JM Sutera 1'"; 
        ...
        // replace the A href link with 
                ...
                <div class="col-lg-12">
                    ...
                    <th><strong>Edit</strong></th>
                        ...
                        <tbody>
<!--where vessel='JM Sutera 1'-->
<?php $query = "SELECT * FROM up_files where exp < now() + interval 30 day and exp NOT IN ('0000-00-00') and vessel='JM Sutera 2'"; 
        ...
        // replace the A href link with 
                ...
                <div class="col-lg-12">
                    ...
                    <th><strong>Edit</strong></th>
                        ...
                        <tbody>
<!--where vessel='JM Sutera 1'-->
<?php $query = "SELECT * FROM up_files where exp < now() + interval 30 day and exp NOT IN ('0000-00-00') and vessel='JM Sutera 3'"; 
